...
大陆人，只要稍加学习下，也能掌握注音。《新华字典》里，每个字除了标上拼音，各版本也一直都标着注音。
...
末笔交叉识别码，会有些人不适应。另外，有些字拆字别扭。（当然，汉字几千年的演变，非常复杂，没有一种形码，拆字会绝对舒服，绝对规范的。况且也没绝对的《规范》可供所有汉字使用者遵守）
...
早期也是不错的方案，商业纠纷和推广力度，导致未能普及，境遇远不比五笔等。字根形似英文字母，易记。
...
虎码 241 字根，比五笔、郑码都多，但其网站提供工具来记忆（练习超过3万分，则字根基本过关），也不难记住。
...
五笔、郑码等，需要看书或通过培训班，来学习掌握复杂的规则、特例，甚至还要记无理码。 

虎码规则如下：

```
字：字根字 Aa，二根字 ABb，三根字 ABC，多根字 ABCZ

词：双字 AB+AB，三字 A+A+AB，多字 A+A+A+...+A
...
这是虎码网站上提供的一个测评工具，任何输入方案的码表（必要时转换下格式），上传后，可得到常用6000字的该输入方案的测评情况：
