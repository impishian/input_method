...
支持顶功的输入法。编码空间少，无法支持大字集。规则多，需要较多的学习和记忆。好处是：在几千字的字集内，熟练后，击键少。
...
- [奕码](https://yima.pages.dev/grand-code/)：三码定长，小码是字根的拼音，重码少。26 键，出简不出全。纯**单字**码表，覆盖 7900 个字。编码最短 2 码，最长 3 码。非顶功方案。（类似：虎码）
