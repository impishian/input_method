...
[逸码V20](https://yima.pages.dev/graceful-code/)是纯形、二码顶、单字输入方案。大集合 A 为 21 键。小集合 B 为 5 键：ERUIO（一丶ㄋ丨丿）。

全码规则为「形形笔笔笔」。单拆：字根+书写的笔顺；两拆：首根+次根的笔顺；多拆+次根+余部的笔顺。

多种[yi码](https://yima.pages.dev/)：

- 奕码：三码定长，小码是字根的拼音，重码少

- 易码：三码定长或者四二顶，归类后268个字根
