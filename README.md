...
不满意者，通常是由于其简码和词组编码跟全码不同，简码并不是全码前几键，以及重码还不够后来的新兴形码优秀。新兴形码，大多既继承了郑码、五笔的字根，又添加了大量字根。当然，在数以万计的大字集下，重码表现要好一些。可是，一般人，只需关注常用几千常用字集内的表现即可，因此，重码率还好。
...
另有说法，86版使用234个字根，98版使用259个字根，新世纪版使用了226个字根。应该是形似根不归并，来统计而得的数量。五笔是商业推广最成功的形码。
...
常见的双拼方案包括：(1)微软、(2)智能ABC、(3)加加、(4)小鹤、(5)搜狗、(6)紫光、(7)自然码。
...
各种魔改的五笔方案、魔改的三笔郑码、各种像 徐码（245 字根）、宇浩（233 字根）等各种受到郑码和五笔启发而设计的**形码**方案、
