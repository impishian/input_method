...
[虎码@PeaceB](https://tiger-code.com/)

**虎码，是取码规则最简单的形码**

虎码 241 字根，比五笔、郑码都多，但其网站提供工具来记忆（练习超过3万分，则字根基本过关），也不难记住。不要像五笔那样背字根，可当成 241 个 Key-Value 对来记。

虎码设计者，按特定计算机算法来排布各字根在哪个键，不像五笔或郑码那样有一定的规律。字根完全乱序，像郑码一样采用双编码（小码音托，不懂拼音者可另想办法记小码，问题也不大）。

面向大字符集。字根多，打字体验就比较好。像搭积木一样，能轻易搭出各种字。比五笔更容易拆字、重码少、极少的无理码。

〔[虎码测评网](http://assess.tiger-code.com/)〕

这是虎码网站上提供的一个测评工具，任何输入方案的码表（必要时转换下格式），上传后，可得到常用6000字该输入方案的统计信息：

(1) 离散情况：用1/2/3/4码能打出的字，分别占比有多少，静态重码率多少；

(2) 效率：理论二简，加权键长；

(3) 手感： 左右互击、手指跨排、 同指/同键连打 ... 等。
